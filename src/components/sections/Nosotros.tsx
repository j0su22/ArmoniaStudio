        ...
        <div className="lg:pl-8">
          ...
          <ScrollReveal delay={0.2}>
            <p className="text-[13px] font-light leading-[1.85] text-warm mb-4 max-w-[480px]">
              Somos un estudio de diseño de interiores y consultoría inmobiliaria con sede en El Salvador.
              Combinamos la visión estética con el conocimiento del mercado para ofrecer una experiencia integral.
            </p>
            <p className="text-[13px] font-light leading-[1.85] text-warm mb-8 max-w-[480px]">
              Nuestra filosofía: cada espacio debe ser bello, funcional y rentable. Trabajamos con
              residencias, Airbnbs, consultorios y espacios comerciales con el mismo nivel de dedicación.
            </p>
          </ScrollReveal>

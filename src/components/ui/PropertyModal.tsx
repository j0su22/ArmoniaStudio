  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          className="relative m-3 lg:m-6 w-full max-w-[1400px] bg-cream flex flex-col-reverse lg:flex-row overflow-y-auto lg:overflow-hidden shadow-2xl"
        ...
        >
          ...
          {/* RIGHT — 70% — galería */}
          <div className="lg:w-[70%] flex flex-col bg-cream-mid overflow-hidden min-h-[260px] lg:min-h-0">
            {images.length > 0 ? (
              <>
                {/* Main image */}

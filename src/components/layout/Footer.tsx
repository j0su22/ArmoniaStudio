...
const DESIGN_LINKS = [
  ...
  { label: 'Home Staging', href: '#portafolio' },
]

const PROPERTY_LINKS = [
  { label: 'En Venta', href: '#propiedades' },
  { label: 'En Alquiler', href: '#propiedades' },
  { label: 'Asesoría Inmobiliaria', href: '#contacto' },
  { label: 'Capta tu propiedad', href: '#contacto' },
]

const CONTACT_INFO = [
  { icon: Phone, text: '+503 0000-0000' },
  { icon: Mail, text: 'hola@armoniaestudio.com' },
  { icon: MapPin, text: 'San Salvador, El Salvador' },
]

const SOCIALS = ['IG', 'FB', 'PT', 'TK']
      ...
      <div className="max-w-[1300px] mx-auto px-16 pt-16 pb-8">
            ...
            <div className="flex gap-3">
              {SOCIALS.map((s) => (
                <a
                  key={s}
                  href="#"
                  className="w-8 h-8 border border-white/12 flex items-center justify-center text-[10px] font-bold text-white/40 hover:border-sage hover:text-sage transition-all duration-200"
                >
                  {s}
                </a>
              ))}
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-3 pt-6">
          <p className="text-[10px] text-white/20 tracking-wide">
            © 2024 Armonía Estudio. Todos los derechos reservados.
          </p>
